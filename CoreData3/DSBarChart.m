...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int barCount = 0; barCount < self.numberOfBars; barCount++) {
        ...
        */
        ...
        iColor = [UIColor colorWithRed:(0) green:(0) blue: heightRatio alpha:1.0];
        //UIColor *new = [UIColor colorWithHue:0.5 saturation:<#(CGFloat)#> brightness:<#(CGFloat)#> alpha:<#(CGFloat)#>]
